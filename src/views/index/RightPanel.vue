      ...
      <el-scrollbar class="right-scrollbar">
        ...
        >
          ...
          <el-form-item v-if="activeData.__vModel__ !== undefined" label="默认值">
            <el-input
              placeholder="请输入默认值"
              :modelValue="activeData.__config__.defaultValue"
              @input="defaultVal"
            />
          </el-form-item>
          <el-form-item
            ...
            label="至少应选"
          >
            <el-input-number v-model="activeData.min" placeholder="至少应选" />
          </el-form-item>
          <el-form-item
            v-if="activeData.__config__.tag === 'el-checkbox-group'"
            label="最多可选"
          >
            <el-input-number v-model="activeData.max" placeholder="最多可选" />
          </el-form-item>
          <el-form-item
          ...
          <el-form-item v-if="activeData['prefix-icon'] !== undefined" label="前图标">
            <el-input v-model="activeData['prefix-icon']" placeholder="请输入前图标名称">
              <template #append>
                <el-button icon="el-icon-thumb" @click="openIconsDialog('prefix-icon')">
                  选择
                </el-button>
              </template>
            </el-input>
          ...
          <el-form-item v-if="activeData['suffix-icon'] !== undefined" label="后图标">
            ...
            >
              <template #append>
                <el-button icon="el-icon-thumb" @click="openIconsDialog('suffix-icon')">
                  选择
                </el-button>
              </template>
            </el-input>
          ...
          >
            <el-input v-model="activeData['icon']" placeholder="请输入按钮图标名称">
              <template #append>
                <el-button icon="el-icon-thumb" @click="openIconsDialog('icon')">
                  选择
                </el-button>
              </template>
            </el-input>
          ...
          <el-form-item v-if="activeData['active-value'] !== undefined" label="开启值">
            <el-input
              ...
              placeholder="请输入开启值"
              @update:modelValue="onSwitchValueInput($event, 'active-value')"
            />
          </el-form-item>
          <el-form-item v-if="activeData['inactive-value'] !== undefined" label="关闭值">
            <el-input
              ...
              placeholder="请输入关闭值"
              @update:modelValue="onSwitchValueInput($event, 'inactive-value')"
            />
          </el-form-item>
          <el-form-item
            v-if="
          ...
          <el-form-item
            v-if="
              activeData.type !== undefined && activeData.__config__.tag === 'el-button'
            "
            label="按钮类型"
          >
...
<script lang="jsx">
  ...
  import { isNumberStr, inputDataFormat } from "@/utils/index";
  ...
  export default {
    ...
    methods: {
      defaultVal(value) {
        this.activeData.__config__.defaultValue = inputDataFormat(value);
      },
        ...
        return (
          <div class="custom-tree-node">
            ...
            <span class="node-operation">
              <i onClick={() => this.append(data)} class="el-icon-plus" title="添加"></i>
              <i
      ...
      tagChange(tagIcon) {
        ...
        if (!target)
          target = selectComponents.find((item) => item.__config__.tagIcon === tagIcon);
